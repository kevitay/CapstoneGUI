...
function EventType({ eventType, setEventType }) {
  ...
  return (
    <>
      ...
      <Select placeholder="Select Event Type" name="event-type" id="event-type" value={optionListSelection} onChange={(e) => setOptionListSelection(e.target.value)} required>
