...
export default function DeleteEvent({ id }) {
  ...
  function handleDeleteEvent() {
    ...
    fetch('http://ad0bcd07c990f4a9d9879e71472608fa-1526526031.us-west-2.elb.amazonaws.com/api/checklist?eventId=' + id, {
      ...
      .then(fetch('http://a53e50bf576c64141b52293976658417-1117441751.us-west-2.elb.amazonaws.com/api/eventParticipants/' + id, {
        method: 'DELETE',
      })
        .then((response) => console.log('Success- Participant List ' + id + ' Deleted'))
        .catch((error) => console.log(error)))

      .then(fetch('http://a53e50bf576c64141b52293976658417-1117441751.us-west-2.elb.amazonaws.com/api/activities/event/' + id, {
        method: 'DELETE',
      })
        .then((response) => console.log('Success- Activity ' + id + ' Deleted'))
        .catch((error) => console.log(error)))

      .then(fetch('http://ad0bcd07c990f4a9d9879e71472608fa-1526526031.us-west-2.elb.amazonaws.com/api/event/' + id, {
        method: 'DELETE',
      })
